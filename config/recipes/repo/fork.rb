if @monorepo or @repository.include?('libs/')
  ...
  ruby_block "fork_#{@name_repo}" do block do
    ...
    req.call(fork, method: Net::HTTP::Patch, body: { description: "", website: "",
      has_actions: true, has_issues: false, has_wiki: false, has_projects: false, has_packages: false, has_releases: false })
